...
class TrainingConfigurationManager:
    ...
    def get_dataingestion_config(self):
        try:
            ...
            ingested_data_dir = Path(os.path.join(self.artifact_dir, DATA_INGESTION_INGESTED_DIR))
            failed_ingestion_dir = Path(os.path.join(self.artifact_dir, DATA_INGESTION_FAILED_INGESTION_DIR))
            ...
            data_ingestion_config = DataIngestionConfig(
                                                    ...
                                                    meta_data_file_name=DATA_INGESTION_METADATA_FILE_NAME,
